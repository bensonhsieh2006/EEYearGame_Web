...
## If you want to build the website yourself from the unity project:

1. Open Unity project
2. File -> Build Profiles -> Add Build Profile
3. Choose WebGL ![Click the following](image.png)
4. Build ![Click the following](image-1.png)
5. Choose the destination project directory, e.g. ```/.../My_Project```
6. Add directory ```/.../My_Project/server```
7. Initialize express backend
    ```bash
    # In /.../My_Project/server:
    npm init -y && npm i express
    ```
8. Add file ```index.js``` in ```/.../My_Project/server``` and paste the following:
    ...
    const unityBuildPath = dirname; // Note: this makes the current working directory visible to all computers over the network.
